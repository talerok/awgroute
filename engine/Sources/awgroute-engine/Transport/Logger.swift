...
/// Логгер с rotation по размеру. Пишет в /var/log/awgroute-engine.log + stderr (launchd подхватит).
final class Logger {

    static let shared = Logger(path: EngineProtocol.Paths.log, maxBytes: 5 * 1024 * 1024)
